            ...
            <form method="POST" action="{{ route("admin.sites.store") }}" enctype="multipart/form-data" id="siteSubmit">
                ...
                <div class="form-group">
                        ...
                        <select class="form-control select2" name="language_code" id="language_code" required>
                            @if(count($language) > 0)
                                @foreach($language as $id => $item)
                                    <option value="{{ $item['code'] }}" {{ ( old('language_code') == $item['code'] ) ? 'selected' : '' }}>{{ $item['language'] }}</option>
                                @endforeach
                            @else
                    ...
                    <div class="form-group">
                        ...
                        <textarea class="form-control {{ $errors->has('javascript_tags') ? 'is-invalid' : '' }}" name="javascript_tags" id="javascript_tags">{{ old('javascript_tags') }}</textarea>
                    ...
                    <div class="form-group">
                        ...
                        <input class="form-control {{ $errors->has('linked_in') ? 'is-invalid' : '' }}" type="text" name="linked_in" id="linked_in" value="{{ old('linked_in', '') }}">
