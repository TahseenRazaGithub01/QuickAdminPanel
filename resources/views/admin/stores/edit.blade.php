    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route("admin.stores.update", [$store->id]) }}" enctype="multipart/form-data" id="storesForm">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('meta_description') ? 'is-invalid' : '' }}" type="text" name="meta_description" id="meta_description" value="{{ old('meta_description', $store->meta_description) }}" required>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('faq') ? 'is-invalid' : '' }}" name="faq" id="faq">{!! old('faq', $store->faq) !!}</textarea>
                @if($errors->has('faq'))
                    <div class="invalid-feedback">
                        {{ $errors->first('faq') }}
                    </div>
