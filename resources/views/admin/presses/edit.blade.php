    ...
    <div class="card-body">
        ...
        <form method="POST" action="{{ route("admin.presses.update", [$press->id]) }}" enctype="multipart/form-data" id="pressForm">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('meta_description') ? 'is-invalid' : '' }}" type="text" name="meta_description" id="meta_description" value="{{ old('meta_description', $press->meta_description) }}" required>
