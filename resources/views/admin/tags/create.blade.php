...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.tags.store") }}" enctype="multipart/form-data" id="tagForm">
            @csrf
            ...
            <div class="form-group">
                <label class="required" for="sites">{{ trans('cruds.tag.fields.site') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.tag.fields.site_helper') }}</span>
            </div>
            <div class="form-group">
