...
<div class="card">
    <div class="card-header">
        {{ trans('global.create') }} {{ trans('cruds.addSpaceProduct.title_singular') }}
    </div>

    <div class="card-body">
        <form method="POST" action="{{ route("admin.add-space-products.store") }}" enctype="multipart/form-data" id="spaceForm">
            @csrf
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('horizontal_script') ? 'is-invalid' : '' }}" name="horizontal_script" id="horizontal_script" required>{{ old('horizontal_script') }}</textarea>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control {{ $errors->has('vertical_script') ? 'is-invalid' : '' }}" name="vertical_script" id="vertical_script" required>{{ old('vertical_script') }}</textarea>
