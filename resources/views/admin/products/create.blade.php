    ...
    <div class="card-body">
        <form method="POST" action="{{ route("admin.products.store") }}" enctype="multipart/form-data" id="productForm">
            ...
            <div class="form-group">
                ...
                <select class="form-control select2 {{ $errors->has('product_categories') ? 'is-invalid' : '' }}" name="product_categories[]" id="product_categories" multiple required>
                    @foreach($product_categories as $id => $product_category)
                        <option value="{{ $id }}" {{ in_array($id, old('product_categories', [])) ? 'selected' : '' }}>{{ $product_category }}</option>
                    @endforeach
                </select>
            ...
            <div class="form-group">
                ...
                <textarea class="form-control ckeditor {{ $errors->has('short_description') ? 'is-invalid' : '' }}" name="short_description" id="short_description">{!! old('short_description') !!}</textarea>
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('discount_price') ? 'is-invalid' : '' }}" type="text" name="discount_price" id="discount_price" value="{{ old('discount_price', '') }}">
            ...
            <div class="form-group">
                ...
                <input class="form-control {{ $errors->has('discount_percent') ? 'is-invalid' : '' }}" type="text" name="discount_percent" id="discount_percent" value="{{ old('discount_percent', '') }}">
            ...
            <div class="form-group">
                <label for="additional_image">{{ trans('cruds.product.fields.additional_image') }}</label>
                ...
                @endif
                <span class="help-block">{{ trans('cruds.product.fields.additional_image_helper') }}</span>
            </div>
            <div class="form-group">
